...
export default function GeminiForm() {
  ...
  return (
    <form
      ...
      className="max-h-[700px] w-[350px] rounded-lg border-2 bg-white px-4 py-10 md:w-[500px] lg:w-[650px]"
    >
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="mt-4 flex items-center gap-2 rounded-lg bg-[#256ff1] px-4 py-1 text-white disabled:cursor-not-allowed"
      >
